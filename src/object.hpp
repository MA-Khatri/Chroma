...
public:
  ...
  // Updates descriptor set to take in this object's uniform buffer
  void VkUpdateUniformBuffer();

  // Uploads this object's ubo data to the GPU
  void VkUploadUniformBuffer();
...
public:
  ...
  struct UniformBufferObject {
    ...
    // We pass in the normal matrix as a mat4 to avoid alignment issues
